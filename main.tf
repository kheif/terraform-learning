...
resource "github_repository_file" "readme" {
  ...
  # Eğer repository auto_init ile oluşturulurken bir README zaten varsa,
  # provider varsayılan olarak var olan dosyanın üzerine yazmayı reddeder.
  # overwrite_on_create ile ilk oluşturma sırasında (create) üzerine yazmayı
  # kabul edebiliriz — bu sayede 404 veya "refusing to overwrite" hatası alınmaz.
